...
export async function GET(req: NextRequest) {
  // NOTE: auth check intentionally REMOVED for this throwaway probe branch only --
  // preview Supabase-session cookies weren't sticking. This route is read-only,
  // returns only public grant-program data (opportunity titles + assistance-listing
  // numbers), exposes NO secret and NO client data, and is DELETED immediately after
  // the field path is confirmed. It must never reach main.
