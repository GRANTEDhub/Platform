...
import GrantBotClient from "./grantbot-client";

export const dynamic = "force-dynamic";

// GrantBot: a conversation about ONE client, over the same context pack the previous brick made
// readable. Staff only.
//
// ITS OWN ROUTE, like the pack, and for the same reason: it assembles a few thousand words before
// it can say anything, and the client record is a page staff open constantly.
//
    ...
    <div>
      ...
      <div className="space-y-6 p-8">
        <div className="flex flex-wrap items-center gap-4">
          ...
          >
            <ArrowLeft className="h-3.5 w-3.5" /> Back to {gathered.clientName}
          </Link>
          <Link
