...
export function DecisionPanel({
  ...
  return (
    <div className="rounded-2xl bg-white p-5 shadow-soft">
      {/* Decision controls (top). The primary action is "Send grant alert" (client
          cards) which also approves the card; it sits above Reject. Prospect cards
          get no send here -- prospect outreach lives in the lead pipeline. */}
      {alertSend}
      {!isAdmin && (
      ...
      {/* Score feedback (below): agree/flag on Argo's 1-3 fit score, independent of
          the decision. */}
