...
export function DecisionBar({
  ...
  return (
    <div className="mt-6 border-t border-brand-navy/[0.06] pt-6">
      ...
      {showPass && !passed && (
        <div className="mt-3 max-w-md space-y-2 rounded-xl border border-brand-navy/10 bg-brand-cream/50 p-3">
      ...
      {/* score feedback */}
      <div className="mt-5 border-t border-brand-navy/[0.06] pt-5">
        ...
        {showFlag && fb === "idle" && (
          <div className="mt-2.5 max-w-md space-y-2 rounded-xl border border-brand-navy/10 bg-brand-cream/50 p-3">
